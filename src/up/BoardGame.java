...
public class BoardGame {
    ...
    public void addYear(int year) { this.year += year; }
...
//        System.out.println(bestGame.name);
    ...
    public void addYearToGame(List<BoardGame> boardGameList, int year){
        boardGameList.stream().filter(g -> g.maxPlayers == 4)
                .limit(5)
                .forEach(System.out::println);
        System.out.println("Dodanie wartosci do elementow listy");
...
//        boardGameList.stream()
//                .sorted(Comparator.comparing(BoardGame::getPrice).thenComparing(BoardGame::getYear))
//                .forEach(System.out::println);
    }
}